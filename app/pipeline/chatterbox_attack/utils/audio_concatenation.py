"""
Audio concatenation utilities for Chatterbox reference audio preparation.
"""
import numpy as np
import librosa
...
def concatenate_with_padding(
    ...
    Chatterbox internally clips reference audio to ~10 seconds for conditioning,
    so the default target_duration is 10.0 (vs 15.0 for other pipelines).
