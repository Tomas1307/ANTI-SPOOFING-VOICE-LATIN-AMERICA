"""
Pipeline configuration schema for CosyVoice attack generation.
"""
...
class CosyVoicePipelineConfig(BaseModel):
    """Configuration for running the CosyVoice attack pipeline.
    ...
    Attributes:
        run_step_1: Whether to run Step 1 (prepare reference audio with STT).
    ...
    run_step_1: bool = Field(default=True, description="Run Step 1: Prepare reference audio with STT")
