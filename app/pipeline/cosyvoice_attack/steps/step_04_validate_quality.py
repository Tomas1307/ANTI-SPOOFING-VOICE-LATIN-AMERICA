...
Validates synthetic speech using:
  ...
  2. Silence detection: rejects near-silent output from CosyVoice.
...
class QualityValidator:
    """Validates quality of generated CosyVoice synthetic speech.
    ...
    def execute(self) -> ValidationResult:
        """Validate quality of all generated CosyVoice samples.
        ...
        MetricsWriter.write_validation_csv(
            ...
            system_id=settings.COSYVOICE_SYSTEM_ID,
            generated=generated,
            validated=validated,
            rejected=rejected,
        )
