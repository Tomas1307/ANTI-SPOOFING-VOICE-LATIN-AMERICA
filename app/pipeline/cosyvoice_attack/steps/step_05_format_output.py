...
Uses COSYVOICE system ID and 11000000+ audio ID range to avoid collisions
...
class OutputFormatter:
    ...
    following ASVspoof2019 LA naming conventions. Uses COSYVOICE as the
    system identifier and audio IDs in the 11000000+ range to avoid collisions.
    ...
    def __init__(
        ...
        self.system_id = system_id or settings.COSYVOICE_SYSTEM_ID
