"""
Audio concatenation utilities for CosyVoice reference audio preparation.
"""
import numpy as np
import librosa
...
def concatenate_with_padding(
    ...
    CosyVoice benefits from longer reference segments for zero-shot voice
    cloning, so the default target_duration is 15.0 seconds (vs 10.0 for
    Chatterbox which internally clips to 10s).
