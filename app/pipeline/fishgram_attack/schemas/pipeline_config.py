"""
Pipeline configuration schema for FishGram attack generation.
"""
...
class FishGramPipelineConfig(BaseModel):
    """Configuration for running the FishGram attack pipeline.
