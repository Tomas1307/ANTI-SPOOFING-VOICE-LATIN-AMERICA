...
class ValidationResult(BaseModel):
    ...
    Attributes:
        ...
        rejected_samples: List of rejected sample IDs with reasons
    ...
    rejected_samples: List[Dict[str, str]] = Field(
        default_factory=list,
        description="List of rejected samples with IDs and rejection reasons"
    )
