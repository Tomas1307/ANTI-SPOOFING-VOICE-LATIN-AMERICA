"""
Pipeline configuration schema for OmniVoice attack generation.
"""
...
class OmniVoicePipelineConfig(BaseModel):
    """Configuration for running the OmniVoice attack pipeline.

    This schema defines the runtime configuration that can be passed to
    the pipeline. Most defaults are defined in settings.py and can be
    overridden here.
    ...
    Attributes:
        ...
        skip_existing_step_3: Skip already-generated WAVs in Step 3 (resume).
    """

    run_step_1: bool = Field(
        default=True,
        description="Run Step 1: Prepare reference audio with Parakeet transcription"
    )
