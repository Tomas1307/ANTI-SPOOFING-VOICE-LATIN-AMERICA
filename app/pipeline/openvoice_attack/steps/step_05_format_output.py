...
Uses OPENVOICE system ID and 7000000+ audio ID range to avoid collisions
with FishGram (9000000+), Qwen (8000000+), and Chatterbox (6000000+) outputs.
"""
import json
import librosa
...
class OutputFormatter:
    ...
    following ASVspoof2019 LA naming conventions. Uses OPENVOICE as the
    system identifier and audio IDs in the 7000000+ range to avoid collisions.
    ...
    def __init__(
        ...
        self.system_id = system_id or settings.OPENVOICE_SYSTEM_ID
