"""
Schema for speech generation result from Step 3.
"""
...
class GenerationResult(BaseModel):
    """Result from synthetic speech generation (Step 3).
    ...
    Attributes:
        ...
        failed_generations: List of sample IDs that failed to generate.
        avg_rtf: Average real-time factor (generation_time / audio_duration).
    """
    ...
    failed_generations: List[str] = Field(
        ...
        description="List of failed sample IDs"
    )
    avg_rtf: float = Field(
        default=0.0,
