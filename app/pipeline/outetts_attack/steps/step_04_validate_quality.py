...
Validates synthetic speech using:
  ...
  2. Silence detection: rejects near-silent output from OuteTTS.
...
class QualityValidator:
    """Validates quality of generated OuteTTS synthetic speech.
    ...
    def execute(self) -> ValidationResult:
        """Validate quality of all generated OuteTTS samples.
        ...
        MetricsWriter.write_validation_csv(
            ...
            system_id=settings.OUTETTS_SYSTEM_ID,
            generated=generated,
            validated=validated,
            rejected=rejected,
        )
