"""
Step 4: Validate Quality with Artifact Detection, Transcription Accuracy,
...
Validates synthetic speech using:
  ...
  5. NISQA MOS estimation: non-intrusive speech quality score (1.0-5.0).
     Informational only, does not reject samples.
  6. ECAPA-TDNN speaker similarity: cosine similarity between reference and
...
class QualityValidator:
    ...
    def execute(self) -> ValidationResult:
        ...
        MetricsWriter.write_validation_csv(
            ...
            system_id=settings.QWEN_SYSTEM_ID,
            generated=generated,
            validated=validated,
            rejected=rejected,
        )
