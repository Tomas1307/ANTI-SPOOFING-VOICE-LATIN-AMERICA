"""
Test script for CosyVoice Attack Pipeline (Validation Mode)

Runs the full 5-step pipeline on 3 speakers with 2 samples each (6 total).
"""
from app.pipeline.cosyvoice_attack import CosyVoiceAttackPipeline
from app.pipeline.cosyvoice_attack.settings import settings

print("=" * 80)
print("COSYVOICE ATTACK PIPELINE - VALIDATION MODE TEST")
print("=" * 80)
print()
...
# Run pipeline
pipeline = CosyVoiceAttackPipeline()
