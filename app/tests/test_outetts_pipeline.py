"""
Test script for OuteTTS Attack Pipeline (Validation Mode)

Runs the full 5-step pipeline on 3 speakers with 2 samples each (6 total).
"""
from app.pipeline.outetts_attack import OuteTTSAttackPipeline
from app.pipeline.outetts_attack.settings import settings

print("=" * 80)
print("OUTETTS ATTACK PIPELINE - VALIDATION MODE TEST")
print("=" * 80)
print()
