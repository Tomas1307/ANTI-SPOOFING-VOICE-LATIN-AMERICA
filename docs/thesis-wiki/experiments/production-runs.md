...
| 2x #4 | 2026-08-03 | On REBUILT partition (voice-similarity merge): 359,198/30,808/27,808; full battery green (ID interleaving, 1 mtime, codec 6/6 within 0.3pp, per-class family mix identical, source_file complete); 409 stale orphans from run #3 quarantined to _archive | **VALID -- canonical 2x** |
